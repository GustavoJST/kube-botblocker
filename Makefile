...
test: manifests generate fmt vet setup-envtest ginkgo ## Run tests.
	...
	OPERATOR_NAMESPACE=kube-botblocker $(TEST) --label-filter='!/CURRENT_NAMESPACE_ONLY/' ./internal/... ./api/... ./pkg/...
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kube-botblocker-builder
	$(CONTAINER_TOOL) buildx use kube-botblocker-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kube-botblocker-builder
	rm Dockerfile.cross
...
helm-docs: $(HELM_DOCS) ## Download helm-docs locally if necessary.
	@echo "==> regenerating helm docs in deploy/charts"
